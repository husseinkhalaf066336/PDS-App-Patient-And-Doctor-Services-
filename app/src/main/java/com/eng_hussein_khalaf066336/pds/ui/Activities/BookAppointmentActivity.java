...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    private void displayNotification() {
        ...
        builder.setSmallIcon(R.drawable.ic_icon_calendar)
                .setContentTitle(getString(R.string.TitleNotification)).setContentText(getString(R.string.TextNotificationAppointment)).setPriority(NotificationCompat.PRIORITY_HIGH)
                .setStyle(new NotificationCompat.BigTextStyle().bigText(getString(R.string.app_name)))
                .setContentIntent(pendingIntent).addAction(R.drawable.ic_icon_calendar, getString(R.string.pendingIntentNotificationAppointment), pendingIntent);
